...
import 'package:carpool_driver/screens/newtripspage.dart';
...
import 'package:carpool_driver/widgets/TaxiOutlineButton.dart';
...
class NotificationDialog extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Image.asset('images/taxi_book.png', width: 100,),

            SizedBox(height: 16.0,),

            Text('YÊU CẦU CHUYẾN XE MỚI', style: TextStyle(fontFamily: 'Lexend-Bold', fontSize: 18),),
  ...
  void checkAvailablity(context){
    ...
    showDialog(
      ...
      context: context,
      builder: (BuildContext context) => ProgressDialog(status: 'Chấp nhận yêu cầu',),
    );
    ...
    newRideRef.once().then((DataSnapshot snapshot) {
      ...
      if(snapshot.value != null){
        ...
        Toast.show("Chuyến đi không tồn tại", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
      }

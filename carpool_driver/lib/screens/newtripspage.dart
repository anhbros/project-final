...
import 'package:carpool_driver/helpers/mapkithelper.dart';
import 'package:carpool_driver/widgets/CollectPaymentDialog.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text(widget.tripDetails.riderName, style: TextStyle(fontSize: 22, fontFamily: 'Lexend-Bold'),),
